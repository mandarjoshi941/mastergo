...
// IntSet warning ko nikalna mushkil hai
...
func main() {
	fmt.Println("*** Part 1: Are these structs comparable?  ***")
	...
	fmt.Println("*** Part 2: Empty struct basics ***")
	...
	fmt.Println("*** Part 2, task 1: Set type ***")
	testSetType()

	fmt.Println("*** Part 2, task 2: iterator ***")
	iterateFrom1ToN(7)
}
